import type { ApplicationError, ExchangeError } from "@jigswap/domain";
...
export const toConvexError = (error: ExchangeError | ApplicationError): ConvexError<{ code: string; message: string }> =>
