...
// Reads the member's federated settings and exposes the solving preferences (duration tracking +
// in-progress sharing) with their setters. Both are undefined until first chosen; the dialogs use
// `trackCompletionDuration` to decide whether to show the secondary first-time prompt. `isLoading`
// guards the initial fetch.
