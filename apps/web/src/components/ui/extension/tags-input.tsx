    ...
    return (
      ...
      >
        <div
          ...
          dir={dir}
          className={cn(
            "flex items-center flex-wrap gap-1 p-1 rounded-lg bg-input/30 overflow-hidden   ring-1 ring-muted  ",
            {
        ...
        >
          {value.map((item, index) => (
            <Badge
              ...
              className={cn(
                "relative pl-2 pr-1 rounded flex items-center gap-1 data-[active='true']:ring-2 data-[active='true']:ring-muted-foreground aria-disabled:opacity-50 aria-disabled:cursor-not-allowed max-w-full",
              )}
              variant={"secondary"}
            >
