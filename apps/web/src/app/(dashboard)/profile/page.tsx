...
import { Pencil, MapPin, Calendar, Star, Package, ArrowRightLeft } from "lucide-react";
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground">2 {t("daysAgo")}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">{t("totalPuzzles")}</p>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-green-600">
                  {userStats?.tradesCompleted || 0}
                </div>
                <p className="text-sm text-muted-foreground">{t("completedTrades")}</p>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">{t("availablePuzzles")}</p>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <div className="text-center">
                <div className="text-lg font-semibold text-primary mb-2">
                  {(userStats?.tradesCompleted || 0) >= 10 ? "Experienced" :
                   (userStats?.tradesCompleted || 0) >= 5 ? "Intermediate" : "Beginner"}
                </div>
