...
import { Search, Filter, Grid, List, Heart, MessageCircle, User, MapPin } from "lucide-react";
...
export default function BrowsePage() {
  ...
  const hasActiveFilters = searchTerm || selectedCategory || selectedDifficulty || selectedCondition || minPieces || maxPieces;
    ...
    <div className="container mx-auto p-6 space-y-6">
        ...
        <CardContent className="p-6">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium mb-2">{tBrowse("minPieces")}</label>
                <input
                  type="number"
                  placeholder="100"
                  value={minPieces}
              ...
              <div>
                <label className="block text-sm font-medium mb-2">{tBrowse("maxPieces")}</label>
                <input
                  type="number"
                  placeholder="5000"
                  value={maxPieces}
      ...
      {puzzles.length === 0 ? (
        <Card>
          <CardContent className="p-12 text-center">
            <div className="text-muted-foreground">
              ...
              <h3 className="text-lg font-medium mb-2">{tBrowse("noPuzzlesFound")}</h3>
        ...
        <div className={viewMode === "grid" 
          ...
          {puzzles.map((puzzle) => (
            <Card key={puzzle._id} className={`group hover:shadow-lg transition-shadow ${viewMode === "list" ? "flex" : ""}`}>
              {viewMode === "grid" ? (
                <>
                  ...
                  <CardHeader className="pb-2">
                    ...
                    <CardDescription className="line-clamp-2">
                      {puzzle.brand && <span className="font-medium">{puzzle.brand}</span>}
                      {puzzle.brand && puzzle.pieceCount && " • "}
                      {puzzle.pieceCount && <span>{puzzle.pieceCount} {t("pieces")}</span>}
                    </CardDescription>
                  </CardHeader>
